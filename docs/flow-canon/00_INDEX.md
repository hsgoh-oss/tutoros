...
| [06_gap_summary.md](06_gap_summary.md) | 도메인×상태 매트릭스 · ⚠️ 충돌 17 목록 | 판정 결과 |
| [07_rollout_plan.md](07_rollout_plan.md) | ONE-SHOT 의존성 순서 M0–M10 · 열린 결정 5 | 계획 |

## 현재 위치 (2026-08-24 실측)

**109 플로우: ✅ 1 · 🔶 44 · ❌ 47 · ⚠️ 17** — 상세는 [06_gap_summary.md](06_gap_summary.md).
결제선생: 파트너 계약·카드 가맹점 등록 완료 / 최초 500,000원 충전 전 (개통 전 수기 경로가 정본 경로).
