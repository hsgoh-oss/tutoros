...
| [06_gap_summary.md](06_gap_summary.md) | 도메인×상태 매트릭스 · ⚠️ 충돌 17 목록(해소 9 · 미해소 8) | 판정 결과 |
| [07_rollout_plan.md](07_rollout_plan.md) | ONE-SHOT 의존성 순서 M0–M10 · 열린 결정 5 | 계획 |

## 현재 위치 (2026-08-25 실측)

**109 플로우: ✅ 13 · 🔶 66 · ❌ 25 · ⚠️ 5** (판정 2026-09-10 4차 — 00023 보존기록 · 00024 옛 포털 토큰 은퇴 · AI 동의 게이트 반영) — 충돌 17 중 12 해소. 상세는 [06_gap_summary.md](06_gap_summary.md).
**구현 완료 체크 15/109 플로우** · 체크박스 112/1193.
마일스톤: **M0 완료**(8d10e5f) · **M1 구조 완료·이행 잔여**(역할별 포털 00017 — 옛 단일 토큰 경로 잔존) · **M2 핵심 완료**(유입 퍼널 00018·37dc2e0) · **M3 L 완료·E 미착수**(수업 묶음·회차 원장 00020) · **M4 부분**(B 코어·검수 준비 — 대사 잔여, c690804·541ab7e) · **M5 일부**(H 구축 4ec60e4 · G-03 충돌 해소 — A 잔여). 상세는 [07_rollout_plan.md](07_rollout_plan.md).
