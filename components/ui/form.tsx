...
const control =
  "ui-control w-full rounded-[var(--radius-field)] border border-line bg-white px-3.5 text-base text-ink placeholder:text-muted/70 outline-none transition-colors focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:bg-soft md:text-[15px]";
