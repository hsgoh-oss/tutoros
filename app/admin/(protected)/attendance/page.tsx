...
export default async function AttendancePage() {
  ...
  return (
    <div className="dash-page">
      ...
      <Card className="mb-6">
        <h2 className="mb-3 text-sm font-semibold text-ink-soft">심사 대기 정정</h2>
      ...
      <Card className="mb-6">
        <h2 className="mb-3 text-sm font-semibold text-ink-soft">귀속 미확정 회차</h2>
      ...
      <Card className="mb-6">
        <h2 className="mb-3 text-sm font-semibold text-ink-soft">예약 위험 검토</h2>
        <p className="mb-3 text-sm text-muted">
